...
class ControllerVoiture {
    ...
    public static function read() {
            $v = ModelVoiture::select(myGet("immat"));   //appel au modèle pour gerer la BD
    ...
    public static function created() {
            ModelVoiture::save(array("marque"=>myGet("marque"), "couleur"=>myGet("couleur"), "immatriculation"=>myGet("immatriculation")));
    ...
    public static function updated() {
            ModelVoiture::update(array("immatriculation" => myGet("immatriculation"), "marque" => myGet("marque"), "couleur" => myGet("couleur")));
            $tab_v = ModelVoiture::selectAll();
