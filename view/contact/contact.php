		...
		<div>
			<form>
				<div class="controls">
						...
						<input class="form-contact" name="nom" type="text" placeholder="Votre nom" required>
				</div>
				<div class="controls">
						<p>Prénom <span class="etoile">*</span></p>
						<input class="form-contact" type="text" name="prenomm" placeholder="Votre prénom" required>
				</div>
				<div class="controls">
						<p>Mail <span class="etoile">*</span></p>
						<input class="form-contact" type="email" name="mail" placeholder="Votre mail" required>
				</div>
				<div class="controls">
					<p>Pays <span class="etoile">*</span></p>
					<select name="pays">
				...
				<div class="controls">
					<p>Date à laquelle vous souhaitez être recontacté : <span class="etoile">*</span></p>
					<input class="form-contact" type="date" name="date" required>
				</div>
				<div>
...
<article class="content">
	...
	<div class="info">
		<h3>Horaires</h3>
		<p><strong>Lundi-Vendredi:</strong> 10h à 18h</p>
		<p><strong>Samedi:</strong> 13h à 18h</p>
