<form method="post" action="index.php?action=<?php echo $target_action;?>">
  <fieldset>
    ...
    <p>
      ...
      <input type="text" placeholder="Ex : Renault" name="marque" id="marque" value="<?php echo htmlspecialchars($v->getMarque());?>" required/>
    </p>

    <p>
      <label for="immat_id">Couleur</label> :
      <input type="text" placeholder="Ex : Bleu" name="couleur" id="couleur" value="<?php echo htmlspecialchars($v->getCouleur());?>" required/>
    </p>
